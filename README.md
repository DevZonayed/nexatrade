...
[![CI](https://github.com/GuiBibeau/nexatrade/actions/workflows/ci.yml/badge.svg)](https://github.com/GuiBibeau/nexatrade/actions/workflows/ci.yml)
...
NexaTrade is an open-source trading terminal for Solana — perps and spot from
one account, with AI you hold the reins on.

Live at [nexatrade.trade](https://nexatrade.trade).

![NexaTrade terminal](https://nexatrade.trade/og/terminal.png)
...
- Funding wizard, daily [recap card](https://nexatrade.trade/og/recap.png),
  [verified-trader Discord](https://nexatrade.trade/discord)

What's coming: [the roadmap](https://github.com/GuiBibeau/nexatrade/issues/528).
...
[Issues](https://github.com/GuiBibeau/nexatrade/issues) ·
[Roadmap](https://github.com/GuiBibeau/nexatrade/issues/528)
