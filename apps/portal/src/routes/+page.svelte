<script lang="ts">
  ...
  import { AssetTable, BrandMark, Button, NewsItem, TabNav } from "@nexatrade/ui";
  import { fmtPct, fmtPrice } from "@nexatrade/ui/format";
...
<svelte:head>
  <title>NexaTrade — SOL to SPACEX. One account.</title>
  <meta
    name="description"
  ...
  />
  <link rel="canonical" href="https://nexatrade.trade/" />
  <meta property="og:title" content="NexaTrade — SOL to SPACEX. One account." />
  ...
  <meta property="og:image" content="https://nexatrade.trade/og/home.png" />
