<script lang="ts">
  import { Button, SiteFooter, SiteNav } from "@nexatrade/ui";
...
<svelte:head>
  <title>Market news — crypto & tokenized stocks | NexaTrade</title>
  <meta
    name="description"
    content="The wire: live headlines across crypto, tokenized equities and pre-IPO names, tagged to tradable markets."
  />
  <link rel="canonical" href="https://nexatrade.trade/news" />
  <meta property="og:title" content="Market news — crypto & tokenized stocks | NexaTrade" />
  <meta
    property="og:description"
    content="The wire: live headlines across crypto, tokenized equities and pre-IPO names, tagged to tradable markets."
  />
  <meta property="og:image" content="https://nexatrade.trade/og/news.png" />
