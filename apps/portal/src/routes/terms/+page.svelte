<script lang="ts">
  import { SiteFooter, SiteNav } from "@nexatrade/ui";
</script>

<svelte:head>
  <title>Terms of Service — NexaTrade</title>
  <meta
    name="description"
    content="The terms that govern your use of NexaTrade, a self-custodial trading interface for spot and perpetual futures on Solana."
  />
</svelte:head>
...
<div class="site">
  ...
  <main class="page">
    ...
    <section class="doc">
      <h2>1. What NexaTrade is</h2>
      <p>
        NexaTrade ("the Service") is a self-custodial trading interface. It
