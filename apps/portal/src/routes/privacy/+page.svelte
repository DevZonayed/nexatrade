...
<svelte:head>
  <title>Privacy Policy — NexaTrade</title>
  <meta
    name="description"
    content="What NexaTrade collects — email, wallet address, usage telemetry, approximate region — and the third parties it relies on."
  />
</svelte:head>
