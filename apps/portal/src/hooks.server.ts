...
const TERMINAL_HEAD = [
  "<title>NexaTrade Terminal — perps &amp; spot on Solana</title>",
  '<meta property="og:title" content="NexaTrade Terminal — perps &amp; spot on Solana" />',
  '<meta property="og:description" content="Phoenix perps and Jupiter spot from one USDC account. Email login, no seed phrase." />',
  '<meta property="og:image" content="https://nexatrade.trade/og/terminal.png" />',
